...
# Info Box
IB <- list(CurrentP3 = "Please, enter the current retirement assets in your Private Pension Fund.",
           CurrentP2 = "Please, enter the current retirement assets in your Occupational Pension Fund.",
           P3purchase = "Please, enter your annual contributions into your Private Pension Fund. Note that SmaRP assumes that the same contributions repeats every year until the retirement.",
           ...
           TaxRelief = "Please, enter here the maximum amount of you can deduct from your taxable income via voluntary contributions to retirement funds.",
           TaxRate = "Please enter here your marginal tax rate.",
           NKids = "Assumption, for more than 5 kids, an additional kid is tax neutral.",
