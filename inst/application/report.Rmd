...
In case of married with double-income couples, SmaRP assumes that all monetary amounts are split 50% and both members of couple have the same age. Please, read the Appendix 3 at the end of this document.
...
Retirement age can be either explicitly provided as an input or inferred from the genre.
