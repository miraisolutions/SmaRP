...
* The user's declares to have `r churchaffiliation` church affiliation. [^1]
...
* Old-age and survivor's insurance (AHV/AVS): `r AHL/100`%.
* Unemployment, accident and invalidity insurance (ALV): `r ALV/100`%.
* Deductions for:
  + Health insurance
