...
SmaRP was originally based on the Swiss retirement system. Most of the functionalities are generic, but the basic configuration and parameters are specific of Switzerland.
The General case is obtained by turning off Swiss-specific modules and requesting conditional inputs.
