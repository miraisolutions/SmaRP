...
SmaRP was originally based on the Swiss retirement system. Most of the functionalities are generic, but the basic configuration and parameters are specifics of Switzerland.
...
SmaRP takes into account ONLY the Occupational pension fund (Pillar II in Switzerland) and a private fund (Pillar III in Switzerland), the ones where one can make decisions during his working career. The state-run pay-as-you-earn system (Pillar I) is law and salary dependent only, meaning there is no active decision-making from the employee which could affect it. Therefore, it is not explicitly considered in SmaRP.
...
* Old-age and survivor's insurance (AHV/AVS): `r params$AHL`
* Unemployment, accident and invalidity insurance (ALV): `r params$ALV`
* Deduction for:
  * Health insurance: `r params$VersicherungsL` plus `r params$VersicherungsV`
  * Married people: `r params$Verheiratet`
