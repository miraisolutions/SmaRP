...
IB <- list(CurrentP3 = "Current retirement assets in your Private Pension Fund.",
           ...
           TaxRelief = "Enter here the maximum amount you can deduct from your taxable income via voluntary contributions to retirement funds.",
           ...
           Salary = "Enter your gross salary. In case of married-double income, enter the aggregated amount.",
