...
`ggplot2` plot made with SmaRP data for a 40-years old person, married, with two childern, family income 100K and affiliated to a church.
</div>
</div>
...
* No easy way to model different scenarios
...
<div class="column7">
**SmaRP: Smart Retirement Planning** is a pension calculator tool, developed as an R package and designed to guide people working in Switzerland towards a strategic decision-making process for their retirement.
</div>
</div>
...
* Flexible & Intuitive
* Detailed personalising parameters


## |

<iframe width="800px" height="1000px" class="shiny-frame" src="`r app_url`"></iframe>
