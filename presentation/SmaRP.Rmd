...
<div style="margin-top:-20px;">
<img src="./municipality_taxAmount.png" height="350px !important;"/>
</div>

`ggplot2` plot made with SmaRP data for a 40-years old person, married, with two childern and affiliated to a church. The boundaries are in a shape file format.
