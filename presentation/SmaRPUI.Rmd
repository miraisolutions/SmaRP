...
- R package and can be downloaded from [CRAN](https://cran.r-project.org/)
- developed by RStudio, integrates well with RStudio IDE

<div style="margin-top:-90px;margin-right:10px;">
...
In **SmaRP**  multiple types of widgets are used, e.g. `selectInput`, `radioButton`, `checkboxInput`, `panel` etc.
...
tags$head(
  tags$style(HTML("a { color: #008cc3;}"))),
  a(id = "git-footer",
