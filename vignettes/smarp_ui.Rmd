...
Even though most components are self explanatory, `bsTooltip`s were added to provide short explanations. They appear in the form of a black box when the user places the cursor on a specific object:
...
![](figures/SmaRP_Pillar_II.png "SamRP_Pillar_II")

![](figures/SmaRP_Pillar_III.png "SamRP_Pillar_III")
